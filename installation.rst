...
Dieses Dokument beschreibt die Installation des Moduls GDPR Opt-in für den OXID eShop (Compilation) 6.0.2 bis 6.1.
...
.. code:: bash
   ...
   composer require --update-no-dev oxid-esales/gdpr-optin-module:^2.1.0
