...
html_context = {
    ...
    'versions': [
         ...
         ('4.4', 'https://docs.oxid-esales.com/modules/gdpr-optin/de/4.4/'),
     ],
    ...
    'github_repo': 'gdpr-optin-documentation',
    'github_version': 'b-4.4-de/'
}
...
htmlhelp_basename = 'GDPROptindoc'
...
latex_documents = [
    (master_doc, 'GDPROptin.tex', 'GDPR-Optin Dokumentation',
